...
final class NetworkManager {
    ...
    func getAppetizers() async throws -> [Appetizer] {
        ...
        // tuple
        // data & response are not Optionals so we don't have to unwrap and handle
        // cases like data == nil or response == error
        // here we don't care about the response code, in all the cases we throw
        // the generic error .invalidData
    ...
    // Old implementation with the completion handler / @escaping closure way
